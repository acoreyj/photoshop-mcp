...
- **Photoshop MCP** — 122 tools incl. 16 recipe workflows (single-undo outcomes)
...
- **Description:** `MCP server + local UI for AI-driven Photoshop automation. 122 tools, recipe workflows, cross-platform.`
